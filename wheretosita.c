...
char result[MAX_N][MAX_NAME_LENGTH];
int v;

//Checks to see if the permutations are valid
...
void genOrderings(int* perm, int* used, int k) {
    if (k == n) {
